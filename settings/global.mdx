...
<ResponseField name="hideFeedbackButtons" type="boolean" default="false">
  <Warning>This option is deprecated. Use `feedback` instead.</Warning>
  Whether or not to hide the `suggestEdit` and `raiseIssue` buttons at the
  top of every page. Defaults to `false`
</ResponseField>

<ResponseField name="feedback" type="Object">
  Customize which feedback buttons to display on your docs
  <Expandable title="Object">
    <ResponseField name="suggestEdit" default="false" type="boolean">
      Allow users to suggest edits on your docs. Defaults to `false`
    </ResponseField>
    <ResponseField name="raiseIssue" default="false" type="boolean">
      Allow users to raise an issue with your docs. Defaults to `false`
    </ResponseField>
  </Expandable>
</ResponseField>
