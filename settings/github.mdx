...
If you are having trouble with the Editor publishing, there are a few ways to debug.

1. Check your GitHub Authorization
   * Found on the `Account` page under `Settings` on the left hand of the dashboard.
   1. Go to the [Account Settings][settings-account-page] page.
   2. You'll see options to "Authorize GitHub Account".
2. Check your GitHub Installation
   1. Visit the [Editor][editor-page].
      * Finish the prompts to complete installation.
      * If you can see the editor, 🥳 congrats, we found no issues.
