...
### Editor isn't Publishing

If you’re having trouble with the Editor publishing your docs, here’s how to troubleshoot:

1. Check GitHub Authorization
   * **Go to the Account page**: Open the left sidebar of the dashboard and click on Settings.
   * **Visit the Account Settings page**: Navigate to the [Account Settings][settings-account-page].
   * **Authorize GitHub Account**: Ensure the “Authorize GitHub Account” option is correctly
configured. This allows Mintlify to communicate with your GitHub account.

2. Verify GitHub Installation
   * **Access the Editor**: Go to the [Editor][editor-page].
   * **Complete the Prompts**: Follow any prompts to finalize the installation.
   * **Check Functionality**: If the editor loads and works properly, the setup is complete.

[settings-account-page]: https://dashboard.mintlify.com/settings/account
[editor-page]: https://dashboard.mintlify.com/editor
